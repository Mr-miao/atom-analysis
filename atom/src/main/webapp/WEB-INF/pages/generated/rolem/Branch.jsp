...
<body>
	...
	<div class="container-ant">
		...
		<!-- 显示导航菜单区域 -->
		<div class="col-sm-2-ant">
			<c:import url="/WEB-INF/pages/template/leftmenu.jsp" />
		</div>

		<!-- 页面底部脚本区域 -->
		<div class="col-sm-10-ant">
		...
		<div class="col-sm-10-ant right" id="content_page">
				...
				<div class="panel-body">
					<div class="form-inline">
						<div class="form-group">
							<label for="branchNo-query">机构编号 <input type="text"
								class="form-control" id="branchNo-query"
								style="margin-top: -5px">
							</label> <label for="branchName-query">机构名字 <!-- <select  id="branchName-query">
						  <option value=""></option>
						</select> --> <input type="text" class="form-control"
								id="branchName-query" style="margin-top: -5px">
							</label>
						</div>
						<!-- 查询按钮 -->
			...
			<div class="panel panel-default data-area">
				<div class="panel-body">
					<div class="btn-group menu-lan">
						<button id="detail" type="button" class="btn btn-default btn-sm">
			  ...
			  <button id="export" type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> 导出</button>-->
					...
					<div class="row-ant">
						<div class="col-sm-12-ant">
							<div class="pager-lan" id="kkpager"></div>
						</div>
					</div>
				</div>
			</div>
				...
				<table class="table border-none">
					<tr>
						...
						<td width="30%"><input type="text" class="form-control"
							id="branchNo" name="branchNo" vtype="required" vmsg="机构编号不能为空"
							unique="true"></td>
						<th width="20%">机构名字 <span style="color: red">*</span></th>
						<td width="30%"><input type="text" class="form-control"
							id="branchName" name="branchName" vtype="required"
							vmsg="机构名字不能为空！"></td>
					</tr>
					<tr class="contactPeople">
						<th width="20%">机构联系人</th>
						<td width="30%"><select
							class="form-control branchContactPeople" id="branchContactPeople"
							onchange="getValue(this.value)" name="branchContactPeople">
								<option value=""></option>
						</select></td>
						<th width="20%">机构联系电话</th>
						<td width="30%"><input type="text" class="form-control"
							placeholder="跟机构联系人同步，无需输入" id="branchContactNumber" readonly
							name="branchContactNumber"></td>
					</tr>
					<tr>
						<th width="20%">机构地址<span style="color: red">*</span></th>
						<td colspan="3"><input type="text" class="form-control"
							id="branchAddr" name="branchAddr" vtype="required"
							vmsg="机构地址不能为空"></td>
					</tr>
					<tr class="branchParent">
						<th width="20%">上级机构<span style="color: red">*</span></th>
						<td width="30%"><select class="form-control branchParentId"
							id="branchParentId" name="branchParentId">
						</select></td>
						<th width="20%">末级机构</th>
						<td width="30%"><select class="form-control" id="ifLeaf"
							name="ifLeaf" vtype="required" vmsg="末级机构不能为空">
								<option value="1">是</option>
								<option value="0">否</option>
						</select></td>
					</tr>
					<tr>
						<td colspan="4"><button id="edit-win-btn"
								class="btn btn-primary btn-block">确认</button></td>
					</tr>
				</table>
			</div>
			<!-- 增加的窗口 end-->
			...
			<div id="edit-win-edit" class="none">
				<input id="branchId-edit" type="hidden" value=""> <input
					id="oldBranchNo-edit" type="hidden" value="">

				<table class="table border-none">
					<tr>
						<th width="20%">机构编号<span style="color: red">*</span></th>
						<td width="30%"><input type="text" class="form-control"
							id="branchNo-edit" name="branchNo" vtype="" unique="true">

						</td>
						<th width="20%">机构名字 <span style="color: red">*</span></th>
						<td width="30%"><input type="text" class="form-control"
							id="branchName-edit" name="branchName" vtype="required"
							vmsg="机构名字不能为空！"></td>
					</tr>
					<tr class="contactPeople">
						<th width="20%">机构联系人</th>
						<td width="30%"><select
							class="form-control branchContactPeople-edit"
							id="branchContactPeople-edit" onchange="getValue(this.value)"
							name="branchContactPeople">
								<option value=""></option>
						</select></td>
						<th width="20%">机构联系电话</th>
						<td width="30%"><input type="text" class="form-control"
							placeholder="跟机构联系人同步，无需输入" id="branchContactNumber-edit"
							readonly name="branchContactNumber"></td>
					</tr>
					<tr>
						<th width="20%">机构地址</th>
						<td colspan="3"><input type="text" class="form-control"
							id="branchAddr-edit" name="branchAddr" vtype="required"
							vmsg="机构地址不能为空"></td>
					</tr>
					<tr class="branchParent">
						<th width="20%">上级机构<span style="color: red">*</span></th>
						<td width="30%"><select
							class="form-control branchParentId-edit" id="branchParentId-edit"
							name="branchParentId" onchange="getBranchParent(this.value)"
							vtype="required" vmsg="上级机构不能为空">
								<option value="0">顶级机构</option>
						</select></td>
						<th width="20%">末级机构</th>
						<td width="30%"><select class="form-control" id="ifLeaf-edit"
							name="ifLeaf" vtype="required" vmsg="末级机构不能为空">
								<option value="1">是</option>
								<option value="0">否</option>
						</select></td>
					...
					<tr>
						<td colspan="4"><button id="edit-win-submit"
								class="btn btn-primary btn-block">确认</button></td>
					</tr>
				</table>
			</div>
			...
			<!-- 高级查询窗口 -->
			<div id="query-advance-win" class="none"></div>
			<!-- 高级查询窗口 end-->

			<!-- 批量编辑窗口 -->
			<div id="batch-edit-win" class="none">
				<div id="batch-edit-content">
					<table id="tb-batch-data"
						class="table table-bordered table-striped table-hover">

					</table>
				</div>
				<div class="tx-right">
					<button id="batch-edit-btn-submit" type="button"
						class="btn btn-primary" style="width: 200px !important;">确定</button>
				</div>
			</div>
			<!-- 批量编辑窗口 end-->
					...
					<div class="panel">
						...
						<div class="panel-body">
							<form method="post" role="form-horizontal"
								enctype="multipart/form-data" id="importExcel">
